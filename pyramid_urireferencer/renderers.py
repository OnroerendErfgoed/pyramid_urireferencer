...
def registry_adapter(obj, request):
    """
    Adapter for rendering a :class:`RegistryResponse` to json.

    :param pyramid_urireferencer.models.RegistryResponse obj:
    The response to be rendered.
    :rtype: :class:`dict`
    """
    return {
            ...
            [
                {
                    ...
                    "count": a.count,
                    "items": (
                        [{"uri": i.uri, "title": i.title} for i in a.items]
...
def application_adapter(obj, request):
    """
    Adapter for rendering a
    :class:`pyramid_urireferencer.models.ApplicationResponse` to json.

    :param pyramid_urireferencer.models.ApplicationResponse obj:
    The response to be rendered.
    :rtype: :class:`dict`
    """
    return {
        ...
        "count": obj.count,
        "items": (
            [{"uri": i.uri, "title": i.title} for i in obj.items]
